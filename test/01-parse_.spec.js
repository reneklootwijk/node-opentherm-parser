...
describe('Check all different data types', function () {
  it('parse a bitmap data type (FLAG8)', function () {
    ...
    assert.strictEqual(result.msgType.text, 'Read-Ack', 'wrong message type reported')
  ...
  it('Parse a float data type (F8_8)', function () {
    ...
    assert.strictEqual(result.msgType.text, 'Read-Data', 'wrong message type reported')
  ...
  it('Parse a daytime data type (DAYTIME)', function () {
    ...
    assert.strictEqual(result.msgType.text, 'Invalid-Data', 'wrong message type reported')
  ...
  it('Parse a date data type (DATE)', function () {
    ...
    assert.strictEqual(result.msgType.text, 'Reserved', 'wrong message type reported')
